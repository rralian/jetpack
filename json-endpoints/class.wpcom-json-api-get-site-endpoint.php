		...
		foreach ( array_keys( $response_format ) as $key ) {
			...
			case 'options':
				...
				if ( $is_jetpack ) {
					...
					$response['options']['json_api_full_management'] = get_option( 'jetpack_json_api_full_management', false );
					$response['options']['wp_updates'] = get_option( 'jetpack_wp_updates', false );
